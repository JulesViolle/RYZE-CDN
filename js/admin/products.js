    ...
    // ═══════════════════════════════════════════════════════════
    // PRODUCTS PAGE - VANILLA JAVASCRIPT
    // ═══════════════════════════════════════════════════════════
    ...
    class ProductsPage {
        ...
        init() {
            ...
            this.attachProductEventListeners(); // ← Move here, call only once
            this.loadProducts();
        }
        ...
        renderProducts(products) {
            ...
            const cards = products.map(product => {
                ...
                const imageUrl = product.images && product.images[0] ? 
                    `{{ base_url }}${product.images[0]}` : '{{ base_url }}/images/placeholder.png';
                    ...
                    <div class="product-card" data-product-id="${product.product_id}">
                        ...
                        <div class="product-card__body">
                            ...
                            <div class="product-card__actions">
                                ...
                                <button 
                                    onclick="simulateAction(this,5000)"
                    ...
                    <div class="modal__body">
                        <form id="editProductForm" style="display: flex; flex-direction: column; gap: 1rem;">
                            ...
                            <div style="display: flex; gap: 0.75rem; margin-top: 1rem;">
                                <button type="submit" class="btn btn--primary" style="flex: 1;" onclick="simulateAction(this,15000)">Save Changes</button>
                        ...
                        <form id="addProductForm" style="display: flex; flex-direction: column; gap: 1rem;">
                            ...
                            <div>
                                ...
                                <select name="status" required style="width: 100%; padding: 0.75rem; background: var(--bg-card); border: 1px solid var(--border-default); border-radius: var(--radius-md); color: var(--text-primary); font-size: 0.875rem; font-family: var(--font-sans);">
                                    ...
                                    <option value="drop-wait">Drop-wait</option>
                                </select>
                            </div>
                            <div>
                                <label style="display: block; font-size: 0.875rem; font-weight: 500; color: var(--text-secondary); margin-bottom: 0.5rem;">Product Images</label>
        ...
        formatCurrency(amount) {
            return `T${amount.toLocaleString('en-US')}`;
        }
    ...
    modal.innerHTML = `
        <div class="modal__content" style="max-width: 480px;">
            <div class="modal__header">
                ...
                <button class="modal__close" id="closeDeleteModal">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
            ...
            <div class="modal__body">
                ...
                <div style="display: flex; gap: var(--space-3);">
                    <button class="btn btn--secondary" id="cancelDelete" style="flex: 1;">
                        Cancel
                    </button>
                    <button class="btn btn--primary" id="confirmDeleteBtn" style="flex: 1; border-color: var(--border-strong);">
                        Delete
                    </button>
                </div>
            </div>
    ...
    modal.querySelector('#closeDeleteModal').addEventListener('click', closeModal);
